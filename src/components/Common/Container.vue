...
<style>
    ...
    .dn-grid-container .dn-grid-widget.placeholder {
...
<script>
import Widget from '../DnWidget/widget'
...
export default {
    ...
    data() {
        return {
            ...
            placeholderWidget: new Widget({ id: '::placeholder::' })
        }
    },
    created() {
        List.add(this)
    ...
    methods: {
        async addWidget(widget) {
            this.$set(this.layout, this.layout.length, widget)
